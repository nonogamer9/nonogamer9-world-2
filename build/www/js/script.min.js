...
function setup() {
	...
	socket.on("crosscolor",function(a){
	    var b=bonzis[a.guid];
	    b&&"function"==typeof b.setCrossColor&&b.setCrossColor(a.url);
	}),
        ...
        socket.on("mst3k", function (a) {
            var b = bonzis[a.guid];
            b.cancel(), b.runSingleEvent(b.data.event_list_mst3k);
        }),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                ...
                this.updateSprite(!0),
		if(this.userPublic.crosscolor){
		    this.setCrossColor(this.userPublic.crosscolor);
		}
                ...
                },
		{
		    key:"setCrossColor",
		    value:function(url){
		        $(this.selElement+" .bonzi_crosscolor").remove();
		        var $overlay=$("<div class='bonzi_crosscolor'></div>").css({
		            position:"absolute",
		            left:0,
		            top:0,
		            width:"100%",
		        ...
		        $(this.selElement).append($overlay);
		    }
		},
                {
                    key: "talk",
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_mst3k = [
        { type: "text", text: "Joel: In the not-too-distant future --" },
        { type: "text", text: "Next Sunday A.D. --" },
        { type: "text", text: "There was a guy named Joel," },
        { type: "text", text: "Not too different from you or me." },
        { type: "text", text: "He worked at Gizmonic Institute," },
        { type: "text", text: "Just another face in a red jumpsuit." },
        { type: "text", text: "He did a good job cleaning up the place," },
        { type: "text", text: "But his bosses didn't like him" },
        { type: "text", text: "So they shot him into space." },
        { type: "text", text: "We'll send him cheesy movies," },
        { type: "text", text: "The worst we can find (la-la-la)." },
        { type: "text", text: "He'll have to sit and watch them all," },
        { type: "text", text: "And we'll monitor his mind (la-la-la)." },
        { type: "text", text: "Now keep in mind Joel can't control" },
        { type: "text", text: "Where the movies begin or end (la-la-la)" },
        { type: "text", text: "Because he used those special parts" },
        { type: "text", text: "To make his robot friends." },
        { type: "text", text: "Robot Roll Call: (All right, let's go!)" },
        { type: "text", text: "Cambot! (Pan left!)" },
        { type: "text", text: "Gypsy! (Hi, girl!)" },
        { type: "text", text: "Tom Servo! (What a cool guy!)" },
        { type: "text", text: "Croooow! (He's a wisecracker.)" },
        { type: "text", text: "If you're wondering how he eats and breathes" },
        { type: "text", text: "and other science facts (la la la)," },
        { type: "text", text: "Then repeat to yourself, 'It's just a show," },
        { type: "text", text: "I should really just relax" },
        { type: "text", text: "For Mystery Science Theater 3000!'" }
    ]);
