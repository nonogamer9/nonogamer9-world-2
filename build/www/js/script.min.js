    ...
    $("#chat_send").click(sendInput),
        ...
        socket.on("img", function(a) {
            ...
            b.$dialog
                ...
                .html('<img src="' + a.url + '" style="max-width:480px;max-height:270px;">')
                .show();
            // If you MUST use an iframe (not recommended for images):
            // b.$dialog.addClass("bubble_autowidth").html('<iframe src="' + a.url + '" style="width:480px;height:270px;border:none;"></iframe>').show();
        });
