...
function setup() {
    ...
    socket.on("image", function (a) {
        var b = bonzis[a.guid];
        b.cancel();
        b.runSingleEvent([{ type: "image", url: a.url }]);
    });
}
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                ...
                (this.run = !0),
                (this.mute = !1),
                (this.eventTypeToFunc = { anim: "updateAnim", html: "updateText", text: "updateText", idle: "updateIdle", add_random: "updateRandom", image: "updateImage" }),
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "updateImage",
                    value: function() {
                        var url = this.event.cur().url;
                        this.$dialog.html("<img src='" + url + "' style='max-width:200px;max-height:200px;'/>").show();
                        this.eventNext();
                    },
                },
                {
                ...
                },
                {
                    key: "image",
                    value: function (url) {
                        this.runSingleEvent([{ type: "image", url: url }]);
                    },
                },
                {
                    key: "exit",
